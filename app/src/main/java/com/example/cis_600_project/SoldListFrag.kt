...
import kotlinx.android.synthetic.main.fragment_soldlist.rview3
 ...
 */
class SoldListFrag : Fragment(),SoldListAdapter.MyItemClickListener {
    // TODO: Rename and change types of parameters
    private var otherID: String? = null
    private var listener: OnRecyclerInteractionListener? = null
    lateinit var myAdapter : SoldListAdapter
    ...
    override fun onStart() {
        super.onStart()
        myAdapter = SoldListAdapter(activity!!.applicationContext,otherID!!)
        rview3.hasFixedSize()
